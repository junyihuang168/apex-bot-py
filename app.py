...
def _execute_virtual_exit(
    ...
    """
    真正发 reduceOnly MARKET 平仓，
    并用 FIFO 从该 bot 的 lots 里记账扣减。
    """
    if qty <= 0:
        return
...
<header>
  <div>
    ...
    <div class="muted">bot 独立 lots 记账 · 基础止损默认 0.5% · 阶梯锁盈</div>
  </div>
