...
# Plan A (exchange-native protective STOP_MARKET): use exchange trigger price type.
# Recommended default for robust liquidation protection is MARK.
STOP_TRIGGER_PRICE_TYPE = str(os.getenv("STOP_TRIGGER_PRICE_TYPE", "MARK")).strip().upper()  # LAST | MARK | INDEX
